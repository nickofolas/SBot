...
class Cleanup(commands.Cog):
    ...
    async def get_messages_for_deletion(
        *,
        ...
        two_weeks_ago = discord.utils.utcnow() - timedelta(days=14, minutes=-5)
    ...
    async def cleanup_bot(
        ...
        **Arguments:**
        ...
        if cc_cog is not None:
            ...
            def is_cc(name): return name in command_names
        else:
            def is_cc(name): return False
        ...
        if alias_cog is not None:
            ...
            def is_alias(name): return name in alias_names
        else:
            def is_alias(name): return False
